    ...
    <div class="login-container">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="password" id="contrasena" name="password" autocomplete="no" value="Darketon12!" onkeyup="validarContrasena()">
                <div id="errorContrasena" class="error-message"></div> <!-- Mensaje de error para la contraseña -->
            </div>
            <div class="form-group">
                <a href="views/request_recuperar.php">¿Olvidaste tu contraseña?</a>
            </div>
