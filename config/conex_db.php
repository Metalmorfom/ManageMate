...
$db_user = $_ENV['USER_MASTERLOGIN'];
$db_password = $_ENV['USER_MASTERLOGIN_PWD'];
...
try {
    ...
    // Verificar la conexión (Ya no es necesario el if, el try-catch capturará el error)
    ...
    // Aquí puedes decidir si deseas terminar el script o manejar el error de otra manera
