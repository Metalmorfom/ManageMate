...
.sidebar a {
    ...
    color: white;
    display: block;
    list-style-type: none; /* Quita el "IL marker" */
}
...
#showSidebarBtn {
    ...
    z-index: 200;
    margin-left: 10px; /* Margen izquierdo añadido */
}
...
.sidebar li {
    margin-bottom: 10px; /* Agrega espacio entre elementos de la lista */
}

.sidebar li:last-child {
    margin-bottom: 0; /* Quita el margen inferior del último elemento de la lista */
}

li:active {
    background-color: transparent !important; /* Hace que el fondo de la lista sea transparente durante el clic */
}

li::marker {
    content: ""; /* Contenido vacío para quitar el marcador de lista */
}

.sidebar a:focus {
    outline: none; /* Quita el borde al enfocar */
    background-color: transparent; /* Hace que el fondo sea transparente cuando se enfoca */
}

.sidebar a:active {
    color: white; /* Mantiene el color del texto blanco cuando se hace clic */
}
